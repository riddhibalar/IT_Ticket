					...
					<table>
						<thead>
							<tr class="table100-head">
								...
								<center><th class="column4">Feedback</th>
								</center>
							</tr>
						</thead>
						<tbody>
							...
							while($result1=$result->fetch_object())
							{
								
								{
									?>
									<tr>
										<td class="column1"><?php echo $result1->fname?></td>
										<td class="column2"><?php echo $result1->lname?></td>
										<td class="column3"><?php echo $result1->email?></td>
										<td class="column4"><?php echo $result1->feedback?></td>
